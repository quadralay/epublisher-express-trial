...
<body id="not-found" class="" wwpage:attribute-class="body-class" style="" wwpage:attribute-style="body-style">
  ...
  <main id="page_content_container" class="ww_skin_notfound_container" tabindex="-1">
    <h1 style="font-size: 100pt;">404</h1>
    <p wwpage:content="file-not-found-message">File Not Found.</p>
    <footer>
     <!-- Google Translation -->
     <!--                    -->
