...
>
 ...
 <!-- Result Page -->
 <!--             -->
 <xsl:variable name="GlobalResultPath" select="wwfilesystem:Combine(wwprojext:GetTargetDataDirectoryPath(), 'reverb_header.xml')" />
 ...
 <xsl:template name="PageTemplate-Conditions">
  ...
  <xsl:if test="wwprojext:GetFormatSetting('header-generate') = 'true'">
   <wwpage:Condition name="header-enabled"/>
  </xsl:if>

  <xsl:if test="wwprojext:GetFormatSetting('header-logo') != 'none' or wwprojext:GetFormatSetting('header-logo-override') != ''">
   <wwpage:Condition name="header-logo-enabled" />
  </xsl:if>

  <xsl:if test="wwprojext:GetFormatSetting('header-logo') = 'company-logo-src'">
   <wwpage:Condition name="company-logo-for-header-logo" />
  </xsl:if>

  <xsl:if test="wwprojext:GetFormatSetting('header-logo') = 'company-name'">
   <wwpage:Condition name="company-name-for-header-logo" />
  </xsl:if>

  <xsl:if test="wwprojext:GetFormatSetting('header-logo-override') != ''">
   <wwpage:Condition name="header-logo-override-exists" />
  </xsl:if>

  <xsl:if test="wwprojext:GetFormatSetting('header-logo-override') = ''">
   <wwpage:Condition name="header-logo-override-not-exists" />
  </xsl:if>

  <xsl:if test="wwprojext:GetFormatSetting('header-logo-linked') = 'true'">
   <wwpage:Condition name="linked-header-logo-enabled" />
  </xsl:if>

  <xsl:if test="wwprojext:GetFormatSetting('header-logo-linked') = 'false'">
   <wwpage:Condition name="linked-header-logo-disabled" />
  </xsl:if>

  <xsl:if test="wwprojext:GetFormatSetting('header-logo-link-address') != ''">
   <wwpage:Condition name="header-logo-link-exists" />
  </xsl:if>
 ...
 <xsl:template name="PageTemplate-Replacements">
  ...
  <!--              -->
  <xsl:if test="wwprojext:GetFormatSetting('header-logo-override') != ''">
   <wwpage:Replacement name="header-logo-src">
    <xsl:attribute name="value">
     <xsl:call-template name="URI-ResolveProjectFileURI">
      ...
      <xsl:with-param name="ParamURI" select="wwprojext:GetFormatSetting('header-logo-override')" />
     </xsl:call-template>
    </xsl:attribute>
   </wwpage:Replacement>
  </xsl:if>
  ...
  <!-- Header Logo Link -->
  <!--                  -->
  <xsl:variable name="VarHeaderLogoLink">
   <xsl:choose>
    <xsl:when test="wwprojext:GetFormatSetting('header-logo-link-address') = 'company-link'">
     <xsl:value-of select="wwprojext:GetFormatSetting('company-link')"/>
    </xsl:when>
    <xsl:when test="wwprojext:GetFormatSetting('header-logo-link-address') != 'button-home' and wwprojext:GetFormatSetting('header-logo-link-address') != ''">
     <xsl:value-of select="wwprojext:GetFormatSetting('header-logo-link-address')"/>
    </xsl:when>
  ...
  <wwpage:Replacement name="header-logo-link" value="{$VarHeaderLogoLink}"/>

  <xsl:variable name="VarHeaderLogoLinkClass">
   <xsl:choose>
    <xsl:when test="wwprojext:GetFormatSetting('header-logo-link-address') = 'company-link'">
  ...
  <wwpage:Replacement name="header-logo-link-class" value="{$VarHeaderLogoLinkClass}"/>
