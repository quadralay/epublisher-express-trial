...
<!--style:DefineListTerm ; #term-conflict-->
### Conflict:

<!--style:DefineListDefinition ; #def-conflict-->
...
<!--style:DefineListTerm ; #term-delta-sync-->
### Delta Sync:

<!--style:DefineListDefinition ; #def-delta-sync-->
...
<!--style:DefineListTerm ; #term-encryption-->
### Encryption:

<!--style:DefineListDefinition ; #def-encryption-->
...
<!--style:DefineListTerm ; #term-metered-connection-->
### Metered Connection:

<!--style:DefineListDefinition ; #def-metered-connection-->
...
<!--style:DefineListTerm ; #term-selective-sync-->
### Selective Sync:

<!--style:DefineListDefinition ; #def-selective-sync-->
...
<!--style:DefineListTerm ; #term-sync-folder-->
### Sync Folder:

<!--style:DefineListDefinition ; #def-sync-folder-->
...
<!--style:DefineListTerm ; #term-version-history-->
### Version History:

<!--style:DefineListDefinition ; #def-version-history-->
...
<!--style:DefineListTerm ; #term-zero-knowledge-->
### Zero-Knowledge Encryption:

<!--style:DefineListDefinition ; #def-zero-knowledge-->
