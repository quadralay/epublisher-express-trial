...
<!-- style:GlossaryTerm ; marker:IndexMarker="glossary:conflict" ; #gloss-term-conflict -->
### Conflict:
...
<!-- style:GlossaryTerm ; marker:IndexMarker="glossary:delta sync" ; #gloss-term-delta-sync -->
### Delta Sync:
...
<!-- style:GlossaryTerm ; marker:IndexMarker="glossary:encryption,encryption:definition" ; #gloss-term-encryption -->
### Encryption:
...
<!-- style:GlossaryTerm ; marker:IndexMarker="glossary:ignore pattern" ; #gloss-term-ignore-pattern -->
### Ignore Pattern:

<!-- style:GlossaryDef ; #gloss-def-ignore-pattern -->
...
<!-- style:GlossaryTerm ; marker:IndexMarker="glossary:metered connection" ; #gloss-term-metered-connection -->
### Metered Connection:
...
<!-- style:GlossaryTerm ; marker:IndexMarker="glossary:retention period" ; #gloss-term-retention-period -->
### Retention Period:

<!-- style:GlossaryDef ; #gloss-def-retention-period -->
...
<!-- style:GlossaryTerm ; marker:IndexMarker="glossary:selective sync" ; #gloss-term-selective-sync -->
### Selective Sync:
...
<!-- style:GlossaryTerm ; marker:IndexMarker="glossary:sync folder" ; #gloss-term-sync-folder -->
### Sync Folder:
...
<!-- style:GlossaryTerm ; marker:IndexMarker="glossary:version history" ; #gloss-term-version-history -->
### Version History:
...
<!-- style:GlossaryTerm ; marker:IndexMarker="glossary:zero-knowledge encryption" ; #gloss-term-zero-knowledge -->
